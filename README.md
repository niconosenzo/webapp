...
The application is served locally at port 8080. Within the playbook execution there is a unit test checking the container is running, if there is no application serving at the giver address, it proceeds with the deploy, otherwise it will stop and exit.
